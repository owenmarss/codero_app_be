...
const seedTeachingPayroll = async () => {
    const teachingPayrolls = [
        // {
        //     nominal: 50000,
        //     jumlah_presensi: 20,
    ...
    const createdPayrolls = await db.teachingPayroll.bulkCreate(teachingPayrolls);

    const attendanceData = await db.teachingAttendance.findAll({
        limit: 10,
    });
...
module.exports = seedTeachingPayroll;