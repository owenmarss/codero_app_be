...
const seedTeachingAttendance = async () => {
    const teachingAttendances = [
        // {
    ...
    await db.teachingAttendance.bulkCreate(teachingAttendances);
    console.log("Attendance have been seeded successfully.");
};

module.exports = seedTeachingAttendance;